...
import { updateModuleFederationProject } from '@nx/react/src/rules/update-module-federation-project';
import applicationGenerator from '@nx/react/src/generators/application/application';
import { normalizeOptions } from '@nx/react/src/generators//application/lib/normalize-options';
import remoteGenerator from '@nx/react/src/generators/remote/remote';
